            ...
            <div className="bg-surface border border-white/5 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-6 border-t border-white/5 mt-8 flex justify-end">
                  <button type="submit" className="flex items-center gap-2 bg-primary hover:bg-primary-hover text-foreground px-8 py-3.5 rounded-xl font-medium transition-colors shadow-lg shadow-primary/20">
                    Next: Add 3D Rooms
                  </button>
                </div>
              </div>
